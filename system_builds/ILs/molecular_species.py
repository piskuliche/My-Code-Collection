def molecule(spectype, num_spec, blength):
    if spectype.lower() == "bmim":
        ...
        atms  = {
                ...
                'kjeps':[0.837, 0.209, 0.192, 0.033, 0.084, 0.092, 0.092, 0.234, 0.117, 0.326, 0.100],
                'rmin':[3.700, 3.600, 1.800, 2.936, 4.550, 2.680, 2.680, 4.020, 2.680, 4.080, 2.680],
        ...
        angs = {
                'name':["C8-C7-N1","C5-N1-C2","C4-N3-C2","H4-C6-N3","H5-C6-N3","H6-C6-N3","H1-C2-N1","H1-C2-N3","N1-C2-H1","N3-C2-H1",
        ...
        angs.update({
                ...
                "H1-C2-N1":[4,30.0,106.8,atms["name"].index(angs['name'][6][:2]),atms["name"].index(angs['name'][6][3:5]),atms["name"].index(angs['name'][6][6:])],
                "H1-C2-N3":[4,30.0,106.8,atms["name"].index(angs['name'][7][:2]),atms["name"].index(angs['name'][7][3:5]),atms["name"].index(angs['name'][7][6:])],
        ...
        dihs = {
                'name':["C2-N3-C4-C5","N1-C5-C4-N3","N1-C2-N3-C4", "H1-C2-N1-C5","H1-C2-N3-C4", "H2-C4-C5-H3", "C4-C5-N1-C7", "C5-C4-N3-C6", 
                        ...
                        "H7-C7-C8-H9", "H8-C7-C8-H10", "C7-C8-C9-C10", "C7-C8-C9-H11", "C7-C8-C9-H12", "H10-C8-C9-C10", "H10-C8-C9-H11", "H10-C8-C9-H12",
        ...
        dihs.update({
                ...
                "C7-C8-C9-C10":[12,0.195,3,0,atms["name"].index(dihs['name'][45][:2]),atms["name"].index(dihs['name'][45][3:5]),atms["name"].index(dihs['name'][45][6:8]),atms["name"].index(dihs['name'][45][9:])], 
                "C7-C8-C9-H11":[12,0.195,3,0,atms["name"].index(dihs['name'][46][:2]),atms["name"].index(dihs['name'][46][3:5]),atms["name"].index(dihs['name'][46][6:8]),atms["name"].index(dihs['name'][46][9:])], 
                "C7-C8-C9-H12":[12,0.195,3,0,atms["name"].index(dihs['name'][47][:2]),atms["name"].index(dihs['name'][47][3:5]),atms["name"].index(dihs['name'][47][6:8]),atms["name"].index(dihs['name'][47][9:])], 
                "H10-C8-C9-C10":[12,0.195,3,0,atms["name"].index(dihs['name'][48][:3]),atms["name"].index(dihs['name'][48][4:6]),atms["name"].index(dihs['name'][48][7:9]),atms["name"].index(dihs['name'][48][10:])], 
                "H10-C8-C9-H11":[12,0.195,3,0,atms["name"].index(dihs['name'][49][:3]),atms["name"].index(dihs['name'][49][4:6]),atms["name"].index(dihs['name'][49][7:9]),atms["name"].index(dihs['name'][49][10:])], 
                "H10-C8-C9-H12":[12,0.195,3,0,atms["name"].index(dihs['name'][50][:3]),atms["name"].index(dihs['name'][50][4:6]),atms["name"].index(dihs['name'][50][7:9]),atms["name"].index(dihs['name'][50][10:])],
                "H9-C8-C9-C10":[12,0.195,3,0,atms["name"].index(dihs['name'][51][:2]),atms["name"].index(dihs['name'][51][3:5]),atms["name"].index(dihs['name'][51][6:8]),atms["name"].index(dihs['name'][51][9:])], 
                "H9-C8-C9-H11":[12,0.195,3,0,atms["name"].index(dihs['name'][52][:2]),atms["name"].index(dihs['name'][52][3:5]),atms["name"].index(dihs['name'][52][6:8]),atms["name"].index(dihs['name'][52][9:])], 
                "H9-C8-C9-H12":[12,0.195,3,0,atms["name"].index(dihs['name'][53][:2]),atms["name"].index(dihs['name'][53][3:5]),atms["name"].index(dihs['name'][53][6:8]),atms["name"].index(dihs['name'][53][9:])]
                })
        imps = {
        ...
        imps.update({
                ...
                "C7-N1-C2-C5":[2,0.6,0,atms["name"].index(imps['name'][1][:2]),atms["name"].index(imps['name'][0][3:5]),atms["name"].index(imps['name'][0][6:8]),atms["name"].index(imps['name'][0][9:])],
                "C4-N3-C2-C6":[2,0.6,0,atms["name"].index(imps['name'][2][:2]),atms["name"].index(imps['name'][0][3:5]),atms["name"].index(imps['name'][0][6:8]),atms["name"].index(imps['name'][0][9:])],
                "H2-C4-C5-N3":[1,0.5,0,atms["name"].index(imps['name'][3][:2]),atms["name"].index(imps['name'][0][3:5]),atms["name"].index(imps['name'][0][6:8]),atms["name"].index(imps['name'][0][9:])],
                "H3-C5-N1-C4":[1,0.5,0,atms["name"].index(imps['name'][4][:2]),atms["name"].index(imps['name'][0][3:5]),atms["name"].index(imps['name'][0][6:8]),atms["name"].index(imps['name'][0][9:])]
                })
        ...
        kjeps=[]
        rmin=[]
        eps=kjeps/4.184     # converts to kcal/mol
        sig= rmin/(2**(1/6)) # converts to sigma rather than rmin
        mass = []
        # Write to the packmol file
        molfile = 'IL_system.pmol'
        pm = open(pmolfile, 'a')
        pm.write("structure bmim.xyz\n")
        pm.write("  number %s\n" % num_spec)
        pm.write("  inside box 2. 2. 2. %s %s %s\n" % (blength, blength, blength))
    ...
    if spectype.lower() == "r32":
        ...
        angs.update({
                "C8-C7-N1":[1,15.0,109.5,atms["name"].index(angs['name'][0][:2]),atms["name"].index(angs['name'][0][3:5]),atms["name"].index(angs['name'][0][6:])],
                "C5-N1-C2":[2,50.0,109.5,atms["name"].index(angs['name'][1][:2]),atms["name"].index(angs['name'][1][3:5]),atms["name"].index(angs['name'][1][6:])],
                "C4-N3-C2":[3,30.0,109.5,atms["name"].index(angs['name'][2][:2]),atms["name"].index(angs['name'][2][3:5]),atms["name"].index(angs['name'][2][6:])],
                "H4-C6-N3":[3,30.0,109.5,atms["name"].index(angs['name'][3][:2]),atms["name"].index(angs['name'][3][3:5]),atms["name"].index(angs['name'][3][6:])],
                "H5-C6-N3":[3,30.0,109.5,atms["name"].index(angs['name'][4][:2]),atms["name"].index(angs['name'][4][3:5]),atms["name"].index(angs['name'][4][6:])],
                "H6-C6-N3":[3,30.0,109.5,atms["name"].index(angs['name'][5][:2]),atms["name"].index(angs['name'][5][3:5]),atms["name"].index(angs['name'][5][6:])]
                })
        dihs = {
                'name':[]
                }
